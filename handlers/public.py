...
def register_public_handlers(bot: TeleBot):
    ...
    def info_handler(message):
        ...
        if admin:
            ...
            lines.append("/remove Имя CONFIRM — удалить клиента из базы, вместе с текущими посещениями. \n"
                         "Пример: /remove Анна CONFIRM")
            lines.append("/set_expire Имя YYYY-mm-dd — указать дату просрочки абонемента. Внимание на формат даты\n"
